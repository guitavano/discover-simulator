...
export default function Home() {
  ...
  return (
    <>
      ...
      <div>
        <div className='max-w-[1024px] mx-auto px-4 sm:px-0 pb-12'>
          <h2 className='text-[28px] sm:text-[36px] mt-5 mb-2 font-bold'>What is Google Discover?</h2>
          <p><strong>Google Discover is a personalized content feed provided by Google.</strong> It appears on the Google app and the Google homepage on mobile devices. The primary purpose of Google Discover is to present users with a continuous stream of <strong>relevant and interesting content based on their search history, browsing activity, and preferences.</strong>
          </p>
          <p>The platform <strong>uses machine learning algorithms</strong> to understand each user's interests and behaviors, allowing it to display articles, news, videos, and other content that aligns with their preferences. The feed is dynamic, meaning it constantly updates and <strong>adapts to provide the most relevant and up-to-date information to users.</strong>
          </p>

          <h2 className='text-[28px] sm:text-[36px] mt-5 mb-2 font-bold'>What is the difference between Google Search and Discover?</h2>
          <p>Google Search is an active search engine that returns relevant web pages and content in response to specific user queries. Google Discover, on the other hand, is a passive content feed that presents personalized articles, news, and videos based on users' interests, search history, and browsing behavior, <strong>without requiring them to enter specific search queries actively.</strong>
          </p>

          <h2 className='text-[28px] sm:text-[36px] mt-5 mb-2 font-bold'>How do I get Google Discover?</h2>
          <p><strong>You can find Google Discover in a few different ways:</strong></p>

          <ol>
            <li>In the Google app;</li>
            <li>On your Android phone or tablet, in your browser on google.com;</li>
            <li>On some devices, swipe right from your device's home screen.</li>
          </ol>

          <p>If you can't find Google Discover on your Google app, make sure your app is updated to the latest version from the app store.</p>

          <h2 className='text-[28px] sm:text-[36px] mt-5 mb-2 font-bold'>How to show up on Google Discover?</h2>

          <p>To increase the likelihood that articles on your site will be indexed in Discover, <a href="https://developers.google.com/search/docs/appearance/google-discover" target="_blank" className='text-[#2E90FA] font-semibold'>Google makes the following recommendations:</a></p>

          <ol>
            <li>Use page titles that accurately reflect the information while avoiding clickbait;</li>
            <li>Include eye-catching, high-quality photos in your content, particularly big graphics that are more likely to bring in Discover visitors.;</li>
            <li>Avoid utilizing incorrect or exaggerated features in the preview content (title, excerpts, or photos) to boost attractiveness or artificially boost engagement;</li>
            <li>Avoid tactics that manipulate appeal by catering to morbid curiosity, titillation, or outrage;</li>
            <li>Provide content that's timely for current interests, tells a story well, or provides unique insights.</li>
          </ol>
        </div>
      </div>
    </>
    ...
    <div className='flex justify-between items-center pt-2'>
      ...
      <div className='flex items-center gap-4'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24" fill="none">
          <path d="M9 12C9 13.3807 7.88071 14.5 6.5 14.5C5.11929 14.5 4 13.3807 4 12C4 10.6193 5.11929 9.5 6.5 9.5C7.88071 9.5 9 10.6193 9 12Z" stroke="#000000" strokeWidth="1.5" />
          ...
          <path d="M19 18.5C19 19.8807 17.8807 21 16.5 21C15.1193 21 14 19.8807 14 18.5C14 17.1193 15.1193 16 16.5 16C17.8807 16 19 17.1193 19 18.5Z" stroke="#000000" strokeWidth="1.5" />
          <path d="M19 5.5C19 6.88071 17.8807 8 16.5 8C15.1193 8 14 6.88071 14 5.5C14 4.11929 15.1193 3 16.5 3C17.8807 3 19 4.11929 19 5.5Z" stroke="#000000" strokeWidth="1.5" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24" fill="none">
